...
public class Program {
	...
	public static void main(String[] args) {
		...
		//O metodo nextLine le ate encontrar uma quebra de linha, lê a entrada do usuario como uma string
		//nextline() tambem serve para encerrar uma instrução, caso de erro int/string por exemplo
		nome = leia.nextLine();
		
		System.out.println("Entre com sexo: ");
		//charAt(0) é para definir o indice que vamos capturar na posição 0,no caso(m ou f)
		...
		//fechar Scanner é boa pratica, serve para nao deixar o objeto rodando, economizar os recursos
		leia.close();
	}
}
